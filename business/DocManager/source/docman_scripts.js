...
Runner.docManager.createFolder = function() {
	var params = {
		...
		height: 235,
		headerContent: '<span style="font-size: 150%;">Create folder</span>',
		footerContent: '<a type="button" class="btn btn-primary" id="footerSaveButton">Save</a>'
		};
...
Runner.docManager.share = function( hash,id ) {
	var params = {
		...
		headerContent: '<span style="font-size: 150%;">Share</span>',
		footerContent: '<a type="button" class="btn btn-primary" id="footerSaveButton">Save</a>',
		width: 700,
		height: 600
	};
...
Runner.docManager.sendfile = function( hash, fname ) {
	var body = "<table><tr><td style='padding:3px;'>To:</td><td style='padding:3px;'><input id='to' value='' class='form-control' placeholder='test@test.com'></td></tr>";
	body+= "<tr><td style='padding:3px;'>Subject:&nbsp;</td><td style='padding:3px;'><input id='subj' value='"+fname+"' class='form-control'></td></tr>";
	body+= "<tr><td style='padding:3px;'>Body:</td><td style='padding:3px;'><textarea id='body' value='' cols=100 rows=10 class='form-control'></textarea></td></tr></table>";
	var win = Runner.displayPopup( {
		html: body,
		header: 'Send file <b>'+fname+'</b>',
		width: 700,
		height: 450,
		footer: "<a type='button' title='' class='btn btn-primary' id='sendfile' href='javascript:void(0)'>Send</a>&nbsp;<a type='button' title='' id=cancelfile class='btn btn-default' href='javascript:void(0)'>Cancel</a>",
