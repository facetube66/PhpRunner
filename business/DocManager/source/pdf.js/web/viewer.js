...
([(function(module, exports, __webpack_require__) {
    ...
    function webViewerInitialized() {
        ...
        var keys;
        if(params.key1)
            keys = "&key1="+encodeURIComponent(params.key1);
        if(params.key2)
            keys+= "&key2="+encodeURIComponent(params.key2);
        if(params.key3)
            keys+= "&key3="+encodeURIComponent(params.key3);
        if(params.key4)
            keys+= "&key4="+encodeURIComponent(params.key4);
        if(params.key5)
            keys+= "&key5="+encodeURIComponent(params.key5);
        
        file = 'table' in params ? "../../mfhandler.php?file=" + encodeURIComponent(params.file) + keys+"&pageType="+params.pagetype+"&table="+encodeURIComponent(params.table)+"&field="+encodeURIComponent(params.field) : file;
    ...
    var PDFDocumentProperties = function() {
        ...
        _createClass(PDFDocumentProperties, [{
            ...
            key: "_parseFileSize",
            value: function() {
                var _parseFileSize2 = _asyncToGenerator(_regenerator["default"].mark(function _callee() {
                    var fileSize, kb, _args = arguments;
                    return _regenerator["default"].wrap(function _callee$(_context) {
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
            ...
            key: "_parsePageSize",
            value: function() {
                var _parsePageSize2 = _asyncToGenerator(_regenerator["default"].mark(function _callee2(pageSizeInches, pagesRotation) {
                    var _this3 = this;
            ...
            key: "_parseDate",
            value: function() {
                var _parseDate2 = _asyncToGenerator(_regenerator["default"].mark(function _callee3(inputDate) {
                    var dateObject;
                    return _regenerator["default"].wrap(function _callee3$(_context3) {
                        while (1) {
                            switch (_context3.prev = _context3.next) {
